...
#define PW_NOTIF_SETTINGS_VIBRATE_LABEL pwStr(PW_STR_NOTIF_SETTINGS_VIBRATE_LABEL)
#define PW_SETTINGS_VIBRATION pwStr(PW_STR_SETTINGS_VIBRATION)
#define PW_VIBRATION_TITLE pwStr(PW_STR_VIBRATION_TITLE)
#define PW_VIBRATION_STRENGTH_LABEL pwStr(PW_STR_VIBRATION_STRENGTH_LABEL)
#define PW_VIBRATION_STRENGTH_LOW pwStr(PW_STR_VIBRATION_STRENGTH_LOW)
#define PW_VIBRATION_STRENGTH_MEDIUM pwStr(PW_STR_VIBRATION_STRENGTH_MEDIUM)
#define PW_VIBRATION_STRENGTH_HIGH pwStr(PW_STR_VIBRATION_STRENGTH_HIGH)
#define PW_SETTINGS_POWER pwStr(PW_STR_SETTINGS_POWER)
#define PW_POWER_TITLE pwStr(PW_STR_POWER_TITLE)
#define PW_POWER_RESTART pwStr(PW_STR_POWER_RESTART)
#define PW_POWER_SHUTDOWN pwStr(PW_STR_POWER_SHUTDOWN)
#define PW_POWER_OFF_MSG pwStr(PW_STR_POWER_OFF_MSG)
